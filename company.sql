...
from WorksOn w join Employee e 
where w.ssn=e.ssn and w.p_no=(select p_no 
							from Project 
							where p_name="IOT")
...
-- 5. For each department that has more than one employees, retrieve the department number and 
