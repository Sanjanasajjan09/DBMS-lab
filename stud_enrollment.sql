...
-- 1. Demonstrate how you add a new text book to the database and make this book be adopted by
-- some department.
insert into TextBook values
...
and e.course=c.course and c.cname="DBMS" 
and e.marks in (select max(marks) 
				from Enroll e1, Course c1 
				where c1.course=e1.course and c1.cname="DBMS");
